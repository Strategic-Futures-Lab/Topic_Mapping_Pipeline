...
The Topic Model module entry in the project file should have the following structure:
```json5
{...
  "model": {
    "lemmas": "path",
...
- `module` points to the model to use:
...
- `docs` is the number of top documnets to keep in the topic data, it is optional and defaults to 20;
...
[< Previous](LemmatiseModule.md) | [Index](index.md) | [Next >](LabelIndexModule.md)
