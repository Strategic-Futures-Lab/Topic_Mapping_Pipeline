...
public class E2_CreateHexMap
{
    ...
    private void checkArgs(String[] args)
    {
        if(args.length < 2)
        {
            System.out.println("\nArguments missing!\n\nPlease supply arguments in the following order: [JSON Input Location] [HexMap Output Location] [Num Clusters] [Cluster Method - AVERAGE|MAX|MIN] [Surround Percentage] [Generic Topic 1] [Generic Topic 2] ...");
            System.exit(1);
        }
        else if(args.length < 5)
        {
            ...
            System.out.println("\nArguments missing!\n\nPlease supply arguments in the following order: [JSON Input Location] [HexMap Output Location] [Num Clusters] [Cluster Method - AVERAGE|MAX|MIN] [Surround Percentage] [Generic Topic 1] [Generic Topic 2] ...");
            System.out.println("Setting: [Num Clusters] to 0 | [Cluster Method] to AVERAGE | [Surround Percentage] to 0 | No generic topics supplied!\n");
        ...
        else
        {
            ...
            {
                System.out.println("\n[Surround Percentage] argument is NOT valid. It must be a valid float between 0 and 1!\n\nPlease supply arguments in the following order: [JSON Input Location] [HexMap Output Location] [Num Clusters] [Cluster Method - Average|Max|Min] [Surround Percentage]");
                System.exit(1);
            }
