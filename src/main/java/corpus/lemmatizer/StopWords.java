...
public class StopWords {
    public static final List<String> STOPWORDS = List.of(
        ...
        // O
        "o","obviously","of","off","often","oh","ok","okay","old","on","once","one","ones","only","onto","or","org",
        "other","others","otherwise","ought","our","ours","ourselves","out","outside","over","overall","own",
        // P
        "p","page","particular","particularly","per","perhaps","placed","please","plus","possible","presumably",
        "probably","provides",
        // Q
        "q","que","quite","qv",
        // R
        ...
        // U
        "u","uh","um","un","under","unfortunately","unless","unlikely","until","unto","up","upon","us","use",
        ...
        "without","wonder","would","would","www",
        // X
        "x",
        // Y
