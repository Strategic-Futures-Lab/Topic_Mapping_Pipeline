...
public class TopicDistribModuleSpecs {
    ...
    public TopicDistribModuleSpecs(JSONObject specs, MetaSpecs metaSpecs){
        ...
        mainTopics = metaSpecs.getDataDir() + (String) specs.getOrDefault("mainTopics", (String) specs.get("topics"));
        mainOutput = metaSpecs.getDataDir() + (String) specs.getOrDefault("mainOutput", (String) specs.get("output"));
